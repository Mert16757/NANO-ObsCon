...
using ASCOM.NANO.ObservingConditions;
...
namespace ASCOM.LocalServer
{
    ...
    public static class SharedResources
    {
        ...
        /// 
        /// Do not call this method from the ObservingConditionsHardware.Dispose() method in your hardware class.
        ///
            ...
            set
            {
                lock (lockObject)
                {
                    if (value)
                    {
                        ...
                        {
                            SharedSerial.PortName = ObservingConditionsHardware.comPort;
                            SharedSerial.DTREnable = true;
